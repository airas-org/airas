...
/*
 * Documentation:
 * Alert — https://app.subframe.com/32f8a386b602/library?component=Alert_3a65613d-d546-467c-80f4-aaba6a7edcd5
 */
...
interface AlertRootProps extends Omit<React.HTMLAttributes<HTMLDivElement>, "title"> {
  ...
  return (
    <div
      className={SubframeUtils.twClassNames(
        ...
        {
          "border border-solid border-warning-100 bg-warning-50": variant === "warning",
          "border border-solid border-success-100 bg-success-50": variant === "success",
          "border border-solid border-error-100 bg-error-50": variant === "error",
          "border border-solid border-brand-100 bg-brand-50": variant === "brand",
        },
        className,
      )}
      ref={ref}
