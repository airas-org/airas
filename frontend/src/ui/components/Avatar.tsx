...
const AvatarRoot = React.forwardRef<HTMLDivElement, AvatarRootProps>(function AvatarRoot(
  {
    variant = "brand",
    size = "medium",
    children,
  ...
  return (
    ...
    >
      ...
      {image ? (
        <img
          className={SubframeUtils.twClassNames("h-8 w-8 flex-none object-cover absolute", {
