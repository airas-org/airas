...
/*
 * Documentation:
 * Checkbox — https://app.subframe.com/32f8a386b602/library?component=Checkbox_3816e3b5-c48c-499b-b45e-0777c6972523
 */
...
interface CheckboxRootProps extends React.ComponentProps<typeof SubframeCore.Checkbox.Root> {
...
const CheckboxRoot = React.forwardRef<HTMLButtonElement, CheckboxRootProps>(function CheckboxRoot(
  { label, disabled = false, checked = false, className, ...otherProps }: CheckboxRootProps,
  ref,
) {
  return (
