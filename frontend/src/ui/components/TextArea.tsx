...
interface TextAreaRootProps extends React.LabelHTMLAttributes<HTMLLabelElement> {
  error?: boolean;
...
const TextAreaRoot = React.forwardRef<HTMLLabelElement, TextAreaRootProps>(function TextAreaRoot(
  {
    error = false,
    variant = "outline",
    label,
