IMAGES_DATASETS = {
    ...
    "COCO": {
        ...
        "num_classes": 80,
        "image_size": "variable",
        "task_type": "Object Detection, Instance Segmentation, Keypoint Detection, Image Captioning",
        "release_year": 2014,
    ...
    "Pascal-VOC": {
        ...
        "num_classes": 20,
        "image_size": "variable",
        "task_type": "Object Detection, Semantic Segmentation, Classification",
        "release_year": 2012,
    ...
    "SVHN": {
        ...
        "num_classes": 10,
        "image_size": "32x32 (RGB)",
        "task_type": "Image Classification, Digit Recognition",
        "release_year": 2011,
        "dependent_packages": ["datasets", "PIL", "numpy"],
    ...
    "Food-101": {
        ...
        "task_type": "Fine-grained Image Classification",
        "release_year": 2014,
    ...
    "Caltech-101": {
        ...
        "task_type": "Object Recognition, Few-shot Learning",
        "release_year": 2006,
        "dependent_packages": ["datasets", "PIL"],
    ...
    "ADE20K": {
        ...
        "task_type": "Semantic Segmentation, Scene Parsing, Instance Segmentation",
        "release_year": 2017,
        "dependent_packages": [
            "datasets",
            "transformers",
    ...
    "Cityscapes": {
        ...
        "task_type": "Semantic Segmentation, Instance Segmentation, Panoptic Segmentation",
        "release_year": 2016,
        "dependent_packages": [
            "cityscapesscripts",
            "pillow",
    ...
    "Oxford-IIIT-Pet": {
        ...
        "task_type": "Fine-grained Image Classification, Semantic Segmentation",
        "release_year": 2012,
        "dependent_packages": [
            "torch",
            "torchvision",
    ...
    "CUB-200-2011": {
        ...
        "task_type": "Fine-grained Visual Classification, Bird Species Classification, Part Localization",
        "release_year": 2011,
        "dependent_packages": [
            "torch",
            "torchvision",
    ...
    "Tiny-ImageNet": {
        ...
        "task_type": "Image Classification, Multi-class Classification",
        "release_year": 2015,
        "dependent_packages": [
            "datasets",
            "pillow",
    ...
    "Omniglot": {
        ...
        "num_classes": 1623,
        "image_size": "105x105",
        "task_type": "Few-shot Learning, One-shot Classification, Meta-learning",
        "release_year": 2015,
        "dependent_packages": [
            "torch",
            "torchvision",
    ...
    "PatchCamelyon": {
        ...
        "num_classes": 2,
        "image_size": "96x96 (RGB)",
        "task_type": "Binary Image Classification",
        "release_year": 2018,
        "dependent_packages": ["datasets", "PIL", "Python"],
    ...
    "FER2013": {
        ...
        "task_type": "Image Classification (Emotion Recognition)",
        "release_year": 2013,
    ...
    "WIDER-FACE": {
        ...
        "image_size": "variable",
        "task_type": "Object Detection (Faces)",
        "release_year": 2016,
    ...
    "VGGFace2": {
        ...
        "task_type": "Face Recognition, Face Verification",
        "release_year": 2018,
        "dependent_packages": [
            "torch",
            "keras-vggface",
    ...
    "BDD100K": {
        ...
        "task_type": "Object Detection, Semantic/Instance Segmentation, Lane Detection, Tracking",
        "release_year": 2018,
        "dependent_packages": [
            "torch",
            "torchvision",
    ...
    "AQUA20": {
        ...
        "num_classes": 20,
        "image_size": "variable",
        "task_type": "Image Classification, Marine Species Recognition",
        "release_year": 2024,
    ...
    "CheXpert": {
        ...
        "task_type": "Multi-label Classification (Medical)",
        "release_year": 2019,
    ...
    "AFHQ": {
        ...
        "task_type": "Fine-grained Classification",
        "release_year": 2020,
        "dependent_packages": ["datasets", "PIL"],
    ...
    "ImageNet-A": {
        ...
        "num_classes": 200,
        "image_size": "variable",
        "task_type": "Image Classification (Robustness)",
        "release_year": 2020,
        "dependent_packages": ["datasets", "PIL"],
    ...
    "Teeth-Segmentation": {
        ...
        "num_classes": 2,
        "image_size": "variable",
        "task_type": "Binary Semantic Segmentation",
        "release_year": 2022,
