...
from airas.workflows.publication.publish_html_subgraph.nodes.prepare_images_for_html import (
    prepare_images_for_html,
)
from airas.workflows.publication.publish_html_subgraph.nodes.upload_html import (
    upload_html,
)
...
def main():
    from airas.workflows.publication.publish_html_subgraph.input_data import (
