...
class HypothesisDrivenResearchService:
    """
    Service for managing hypothesis-driven research tasks.
    Reuses the same E2E database model and repository as topic-based research.
    """
