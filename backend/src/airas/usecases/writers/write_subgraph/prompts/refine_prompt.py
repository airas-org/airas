...
- Ensure proper citation placement and format throughout the paper.
    ...
    - Examples: [@vaswani-2017-attention], [@devlin-2018-bert; @brown-2020-language], [@vaswani-2017-attention, s1.p2] for a listed passage
    - Never invent a citation key; use only those in Reference Candidates
