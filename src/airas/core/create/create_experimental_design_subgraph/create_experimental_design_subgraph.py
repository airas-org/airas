...
from airas.core.create.create_experimental_design_subgraph.input_data import (
    create_experimental_design_subgraph_input_data,
)
from airas.core.create.create_experimental_design_subgraph.nodes.generate_advantage_criteria import (
    generate_advantage_criteria,
)
from airas.core.create.create_experimental_design_subgraph.nodes.generate_experiment_code import (
    generate_experiment_code,
)
from airas.core.create.create_experimental_design_subgraph.nodes.generate_experiment_details import (
...
class CreateExperimentalDesignSubgraph:
    ...
    def run(
        ...
        input_state_keys = CreateExperimentalDesignInputState.__annotations__.keys()
        output_state_keys = CreateExperimentalDesignOutputState.__annotations__.keys()
